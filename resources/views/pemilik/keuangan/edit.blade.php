...
<h1 class="text-slate-50 text-xl mt-4 ml-4">Ubah Data Keuangan</h1>
@endsection
        ...
        <div class="grid grid-cols-1 p-4 gap-2">
            <div class="grid grid-cols-5 p-2 gap-2">
                ...
                <div class="col-span-3">
                    <input type="number" class="bg-[#91a1c5] w-full px-4 py-2 rounded-lg border border-slate-50 font-bold text-[#3b5998]" name="pengeluaran" value="{{$data->pengeluaran}}">
                </div>
                <div>
                ...
                <div class="col-span-3">
                    <input type="number" class="bg-[#91a1c5] w-full px-4 py-2 rounded-lg border border-slate-50 font-bold text-[#3b5998]" name="pendapatan" value="{{$data->pendapatan}}">
                </div>
            </div>
        </div>
    </div>
