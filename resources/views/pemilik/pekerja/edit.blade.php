...
@section('konten')
<form action="/pekerja/update/{{$data->id}}" method="post">
    @csrf
        ...
        <div class="grid grid-cols-1 p-4 gap-2">
            <div class="grid grid-cols-5 p-2 gap-2">
                ...
                <div class="col-span-4">
                    <input type="text" class="bg-[#91a1c5] w-full px-4 py-2 rounded-lg border border-slate-50 font-bold text-[#3b5998]" name="nama_pekerja" value="{{ $data->nama_pekerja }}">
                </div>
                <div>
                ...
                <div class="col-span-4">
                    <textarea name="alamat" class="bg-[#91a1c5] w-full px-4 py-2 rounded-lg border border-slate-50 font-bold text-[#3b5998]" rows="5">{{ $data->alamat }}</textarea>
                </div>
                <div>
                ...
                <div class="col-span-4">
                    <input type="password" class="bg-[#91a1c5] w-full px-4 py-2 rounded-lg border border-slate-50 font-bold text-[#3b5998]" name="password" value="{{$data->password}}">
